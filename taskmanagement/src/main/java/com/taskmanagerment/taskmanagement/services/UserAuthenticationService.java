...
public class UserAuthenticationService {
    ...
    public AuthResponseDTO login(LoginRequestDTO login) {
        ...
        UserAuthentication profile = userAuthRepo.findByUserOfficialEmail(login.getUserOfficialEmail())
        ...
        UserAuthentication safeProfile = UserAuthentication.builder()
            .username(user.getUsername())
            .userOfficialEmail(user.getUserOfficialEmail())
            .role(user.getRole())
            .actice(user.isActice())
            .createdAt(user.getCreatedAt())
            .build();

        
        System.out.println("Generated JWT Token: " + safeProfile.getRole());

        

        return new AuthResponseDTO(token, "token got generated",safeProfile);
    }
